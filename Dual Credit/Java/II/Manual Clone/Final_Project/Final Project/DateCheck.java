...
public class DateCheck {
    ...
    public boolean isRentDue (){
        ...
        if (systemYear > givenYear){
            ...
            int date = 15-givenDay;
            if (givenMonth == 3){
                if (leapYear){
                    if (systemDay >= 29-givenDay){
                        return true;
                    }
                } else{
                    if (systemDay >= 28-givenDay){
                        return true;
                    }
                }
            } else if (givenMonth == 1 || givenMonth == 2 || givenMonth == 4 || givenMonth == 6 || givenMonth == 8 || givenMonth == 9 || givenMonth == 11){
                if (systemDay >= 31-givenDay){
                    return true;
                }
            } else if (givenMonth == 5 || givenMonth == 7 || givenMonth == 10 || givenMonth == 12){
                if (systemDay >= 30-givenDay){
                    return true;
                }
            }

        } else if (systemDay == (givenDay - 15)){
            return true;
        }
    ...
    public String generateRentText (){
        String returnString;
        returnString = "'s rent is due on " + getFormattedDate() + ".";
        return returnString;
    }
}
