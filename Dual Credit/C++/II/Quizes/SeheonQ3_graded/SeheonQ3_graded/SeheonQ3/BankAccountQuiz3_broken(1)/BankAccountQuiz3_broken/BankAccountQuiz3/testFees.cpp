...
int main()
{
   ...
   //TODO:  No, we do not create objects using new in this class. -5
   CheckingAccount checkAcct; //* checkAcct; = new CheckingAccount();
   //TODO:  just assign the address of the object -3
 //  accounts[0] = checkAcct;
   ...
   SavingsAccount saveAcct; // *saveAcct = new SavingsAccount();
   //ES changed the . to ->, syntax error
   //TODO:  You would not have to do this if you did not change everything 
  // saveAcct->SetInterestRate(0.75);
   saveAcct.SetInterestRate(0.75);
  // accounts[1] = saveAcct;
   //TODO: again, just the address  -3
   accounts[1] = &saveAcct;
